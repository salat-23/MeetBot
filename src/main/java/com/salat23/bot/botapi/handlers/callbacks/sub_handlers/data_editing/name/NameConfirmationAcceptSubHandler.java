...
@Component
public class NameConfirmationAcceptSubHandler implements ICallbackSubHandler {

    private final MessageBuilder messageBuilder;
    private final UserRepository userRepository;

    public NameConfirmationAcceptSubHandler(MessageBuilder messageBuilder, UserRepository userRepository) {
    ...
    public boolean handle(User user) throws TelegramApiException {
        ...
        String response = messageBuilder.getMessageTextByType(ResponseTemplateTypes.NAME_ENTER_AFTER_CONFIRM);

...
@Component
public class GenderConfirmationAcceptSubHandler implements ICallbackSubHandler {

    private final MessageBuilder messageBuilder;
    private final UserRepository userRepository;

    public GenderConfirmationAcceptSubHandler(MessageBuilder messageBuilder, UserRepository userRepository) {
    ...
    public boolean handle(User user) throws TelegramApiException {
        ...
        String response = messageBuilder.getMessageTextByType(ResponseTemplateTypes.GENDER_ENTER_AFTER_CONFIRM);

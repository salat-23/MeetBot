...
@Component
public class AgeConfirmationAcceptSubHandler implements ICallbackSubHandler {

    private final MessageBuilder messageBuilder;
    private final UserRepository userRepository;

    public AgeConfirmationAcceptSubHandler(MessageBuilder messageBuilder, UserRepository userRepository) {
    ...
    public boolean handle(User user) throws TelegramApiException {
        ...
        String response = messageBuilder.getMessageTextByType(ResponseTemplateTypes.AGE_ENTER_AFTER_CONFIRM);

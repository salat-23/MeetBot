...
@Component
public class CityConfirmationDeclineSubHandler implements ICallbackSubHandler {
    private final MessageBuilder messageBuilder;
    private final UserRepository userRepository;

    public CityConfirmationDeclineSubHandler(MessageBuilder messageBuilder, UserRepository userRepository) {
    ...
    public boolean handle(User user) throws TelegramApiException {
        ...
        String response = messageBuilder.getMessageTextByType(ResponseTemplateTypes.CITY_ENTER_AFTER_DECLINE);

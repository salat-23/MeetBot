...
@Component
public class TargetAgeMaxReceiveSubHandler implements IMessageSubHandler {
    ...
    public TargetAgeMaxReceiveSubHandler(MessageBuilder messageBuilder,
    ...
    public List<UserState> getSupportedStates() {
        return List.of(UserState.ENTERING_TARGET_AGE_MAX);
    }
    ...
    public boolean handle(User user, String message) throws TelegramApiException {
        ...
        switch (ageStatus) {
            case WRONG_FORMAT: {
                ...
                String responseText = messageBuilder.getMessageTextByType(ResponseTemplateTypes.TARGET_AGE_WRONG, user.getGender());
            ...
            case OK: {
                int age = ageConfirmer.getLastCheckedAge();
                if (age < user.getTargetMinAge()) {
                ...
                user.setTargetMaxAge(age);
                user.setState(UserState.ASK_CONFIRMING_TARGET_AGE);
                userRepository.save(user);

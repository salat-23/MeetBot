package com.salat23.bot.botapi.handlers.callbacks.sub_handlers.data_editing.name;
...
@Component
public class NameConfirmationDeclineSubHandler implements ICallbackSubHandler {
    private final MessageBuilder messageBuilder;
    private final UserRepository userRepository;

    public NameConfirmationDeclineSubHandler(MessageBuilder messageBuilder, UserRepository userRepository) {
    ...
    public boolean handle(User user) throws TelegramApiException {
        ...
        String response = messageBuilder.getMessageTextByType(ResponseTemplateTypes.NAME_ENTER_AFTER_DECLINE);
